...
module.exports = function (middleware, router, controllers) {
  ...
  // Blog
  router.post('/api/v2/postblog', apiv2Auth, isAdmin, apiv2.blog.postBlog);
  router.get('/api/v2/getblog', apiv2Auth, isAdmin, apiv2.blog.getBlog);
  router.post('/api/v2/deleteblog', apiv2Auth, isAdmin, apiv2.blog.deleteBlog);
  router.put('/api/v2/editblog', apiv2Auth, isAdmin, apiv2.blog.editBlog);
};
